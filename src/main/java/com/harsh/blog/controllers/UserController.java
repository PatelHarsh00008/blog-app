...
public class UserController {
	...
	@PutMapping("/{userId}")
	public ResponseEntity<UserDto> updateUser(@Valid @RequestBody UserDto ulserDto, @PathVariable Integer userId){
		UserDto updatedUser = this.userService.updateUser(ulserDto, userId);
